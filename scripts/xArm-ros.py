...
def ros_main():
    ...
    arm = controller.add_arm("arm", pkg_path+"/config/xArm-49795F663732-arm.json", urdf_file)
    arm.enable()
    arm.home()

    gripper = controller.add_arm("gripper", pkg_path+"/config/xArm-49795F663732-gripper.json")
    gripper.enable()
    gripper.home()
